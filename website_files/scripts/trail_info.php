<?php
	...
	$query = 'SELECT * FROM trail_info'; //tells the database what data we want
	...
	{
		$trail_info[] = $row; //format data
	}
	
	header('Content-Type: application/json');
	echo json_encode($trail_info); //returns our data in json format
